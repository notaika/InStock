        ...
        <div className="warehouse__list-item">
          <div className="warehouse__list-container">
            ...
            <div className="warehouse__list--right">
              ...
              <p className="warehouse__contact-information">
          ...
          <div className="warehouse__list-functions">
            <Link
              to={`warehouse/delete/${warehouse.id}`}
              className="warehouse__function-link"
            >
              <img
                src={deleteIcon}
      ...
      <section className="warehouse__list warehouse__list--tablet">
        <div className="warehouse__list-content">
          <div className="warehouse__list-item">
            <Link
              to={`/warehouse/${warehouse.id}`}
              className="warehouse__list-nav warehouse__info"
            >
              {warehouse.warehouse_name}
              <img
                src={chevronRight}
            ...
            <p className="warehouse__contact-name warehouse__info">
              {warehouse.contact_name}
            </p>
